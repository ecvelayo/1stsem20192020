...
@section('content')
	...
	@endphp
	    ...
	    @foreach($orders as $o)
        {!! Form::open(['action' => ['EateryPagesController@redeemAccept', $o->order_id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
            ...
            <td scope="col" >
                 ...
                 {!! Form::close() !!}
                                <a class="btn btn-danger" href="{{ url('/eatery/redeem_delete/'.$o->order_id) }}"> Delete </a> 
                            </td>
		        @endif
		    </tr>
	        @endif
