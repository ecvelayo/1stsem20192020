        ...
        <nav class="navbar navbar-expand-lg navbar-info pl-5 navbar-dark" style="background-color:#a23131">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <a class="navbar-brand" href="#"><img class="logo" src="../imgs/logo.png" width="80px" height="70px" style="margin-top:-10px;"></a>
                    <a class=" text-white navbar-brand" href="/cashier/home">Cashier</a>
                    ...
                    <a class=" text-white navbar-brand" href="/cashier/cashier_request">Register Request</a>
                    <a class=" text-white navbar-brand" href="/cashier/redeem_request">Redeem Request</a>
                </ul>
